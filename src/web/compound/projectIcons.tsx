...
// Project-icon picker registry. The set of icons + name mapping is shared
// across every `thefactory-*` consumer so a user-picked project icon is
// portable: "research" means the same glyph on desktop, web, and mobile.
//
// Names are kebab-case, derived from the icon component name minus the
// `Icon` prefix. When adding a new icon to `../icons/`, add an entry here
// too so it shows up in pickers.

export type ProjectIconKey = string

export const PROJECT_ICON_REGISTRY: Record<ProjectIconKey, (props: any) => JSX.Element> = {
