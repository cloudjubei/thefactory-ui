...
export type ExtraMcpToolSet = unknown

export type EntityFilter = unknown
...
export type AppActivityDefinition = {
  activityType: string
  recordType: RecordTypeMapping
  steps: Array<ActivityStepSpec>
  lane?: string
  requiresApi?: boolean
}
...
export type CliAuthStatus = {
  ...
  message?: string
  checkedAt: string
  source: CliAuthStatusSource
}

export type CliAuthVerdict = {
  authenticated: boolean
  reason?: 'auth-expired' | 'missing' | 'unknown'
  message?: string
}
...
export type CheckCliAuthStatusParams = {
  credentialId: string
}

export type StartCliReauthParams = {
  credentialId: string
}

export type CliReauthStartResult = {
  loginId: string
  cli: CliTool
  signInUrl?: string
}
...
export type CursorResidentProtocolOptions = {
  cwd: string
...
export type BridgeDelivery = {
  bridgeMcpName: string
  bridgeCommand: string
  bridgeArgs: Array<string>
}
...
export type DataCapabilityView = {
  view: string
  params?: {
    [key: string]: string
  }
...
export type DataCapabilityType = {
  type: string
  label?: string
  description?: string
  editable?: boolean
...
export type DataCapabilityManifest = {
  types: Array<DataCapabilityType>
  activities?: Array<string>
  activityDefinitions?: Array<AppActivityDefinition>
}

export type UpdateProjectRecordArgs = {
  type: string
  key: string
  set: {
    [key: string]: unknown
...
export type CreateProjectRecordArgs = {
  type: string
  content: {
    [key: string]: unknown
  }
...
export type StartProjectActivityArgs = {
  activityType: string
  params?: {
    [key: string]: unknown
  }
...
export type ProjectDataRecordView = DataRecord & {
  resourceLink?: string
}

export type QueryProjectDataResult = {
  records: Array<ProjectDataRecordView>
  total: number
}

export type ProjectDataDispatchResult =
  | {
      matched: true
      result: unknown
    }
...
export type IdentityReliability = 'reliable' | 'provisional' | 'underspecified' | 'unreliable'
...
export type AccessoryRelation = 'refill' | 'part' | 'accessory' | 'case' | 'works-with'
...
export type ProductTypeCheck = {
  onTypeForms: Array<string>
  onTypeTerms: Array<string>
  offTypeRules: Array<ProductTypeRule>
}

export type ProductTypeVerdict = {
  type: 'on-type' | 'off-type' | 'uncertain'
  label?: string
  matched?: string
}

export type CatalogNoiseReport = {
  total: number
  onType: Array<string>
  uncertain: Array<string>
  offType: Array<{
    key: string
    name: string
    label: string
...
export type ProductUserOverlay = {
  productKey: string
  note?: string
  criteria?: {
    [key: string]: CriterionVerdict
...
export type BrandCriterionLedger = {
  pass: number
  fail: number
  abstain: number
  material?: string
...
export type BrandRecord = {
  ...
  summary?: string
  ledger?: {
    [key: string]: BrandCriterionLedger
  }
  updatedAt: string
}
...
export type MaterialRecyclability = 'high' | 'medium' | 'low' | 'none' | 'unknown'
...
export type CatalogBuildCaps = {
  ...
  maxOfferBackfillEmpties?: number
...
export type RecommendTraceEvent = {
  at: string
  phase: 'gather' | 'search' | 'read' | 'extract' | 'enrich' | 'backfill' | 'verify' | 'infer'
...
export type CollisionSignal = {
  kind: 'type-divergence' | 'price-fanout'
  detail: string
  values: Array<string>
}
...
export type EnrichProductResult = {
  ...
  changed: boolean
  merged: boolean
  reliabilityBefore: IdentityReliability
  reliabilityAfter: IdentityReliability
  recovered: {
...
export type BuildProductCatalogResult = {
  ...
  builtAt: string
  market: string
  degradations?: Array<DegradationEvent>
  offerBackfill?: {
    attempted: number
    found: number
    empty: number
...
export type BuildProductCatalogToTargetResult = {
  recordType: string
  count: number
...
export type MaterialKnowledgeSeed = {
  name: string
  slug?: string
  aliases?: Array<string>
  isPlastic?: boolean
...
export type SeedMaterialsParams = {
  scope: string
  recordType: string
...
export type ClearCatalogParams = {
  scope: string
  recordType: string
...
export type CheckCliAuthStatusData = {
  body: {
    credentialId: string
  }
  path?: never
...
export type CheckCliAuthStatusResponses = {
  /**
   * Default Response
   */
  200: CliAuthStatus
...
export type CheckCliAuthStatusResponse =
  CheckCliAuthStatusResponses[keyof CheckCliAuthStatusResponses]
...
export type RunTrainerToolData = {
  ...
  path: {
    ...
    projectId: string
    /**
     * The trainer tool to run (a safe read / interactive-RPC tool).
     */
    toolName: string
  }
  query?: never
...
export type RunTrainerToolResponses = {
  /**
   * Default Response
   */
  200: unknown
