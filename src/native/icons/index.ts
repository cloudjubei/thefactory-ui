// Branded SVG icon set — native mirror of src/web/icons.
// Every component is a react-native-svg rendering of the web original.
// Props: { size?: number; color?: string } instead of { className?: string }.
