...
export function StoryCard({
  ...
  const body = (
    <>
      ...
      {story.description ? <Markdown text={story.description} /> : null}
      ...
      {footer}
      {showStatus && <StatusControl status={story.status} onChange={onStatusChange} />}
    </>
  )
  ...
  if (onPress) {
    return (
      <Pressable
        ...
        accessibilityLabel={ariaLabel ?? `Story ${story.id} ${story.title}`}
        onPress={onPress}
